              ...
              <div className="row mb-4">
                <div className="col">
                  ...
                  <div className="descr">
                    ...
                    >
                      Васильевой Наталией Леонидовной
                    </span>{" "}
                    (далее&nbsp;— Оператор).
                  </div>
                  <div className="ol">
                ...
                <div className="col">
                  ...
                  <div className="ol">
                    ...
                    <div className="li">
                      ...
                      к&nbsp;которым предоставлен субъектом персональных данных
                      путем дачи согласия на&nbsp;обработку персональных данных,
                      разрешенных субъектом персональных данных для
                      распространения в&nbsp;порядке, предусмотренном Законом
                      о&nbsp;персональных данных (далее&nbsp;— персональные
                    ...
                    <div className="li">
                      ...
                      данных) или на&nbsp;ознакомление с&nbsp;персональными
                      данными неограниченного круга лиц, в&nbsp;том числе
                ...
                <div className="col">
                  ...
                  <div className="ol">
                    ...
                    <div className="li">
                      ...
                      оснований, указанных в&nbsp;Законе о&nbsp;персональных
                      данных;
                    </div>
                    <div className="li">
                    ...
                    <div className="li">
                      ...
                      обработку и&nbsp;уничтожить персональные данные
                ...
                <div className="col">
                  ...
                  <div className="ol">
                    ...
                    <div className="li">
                      ...
                      таких персональных данных. Перечень информации
                          ...
                          <tr>
                            ...
                            <td className="purpose-field">
                              <span className="mark link">
                                оформление заказа по покупке букета{" "}
                              </span>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td className="types-field">
                              <ul>
                                <li>
                                  <span className="mark link">
                                    звонка на указанный номер телефона для
                                    оформления заказа по покупке букета
                                  </span>
                                </li>
                              </ul>
                            </td>
              ...
              <div className="row mb-4">
                <div className="col">
                  ...
                  <div className="ol">
                    ...
                    <div className="li">
                      8.3. В&nbsp;случае выявления неточностей
                      ...
                      >
                        sladko-eshka-kanash@sladko-eshka-kanash.ru
                      </span>
                    ...
                    <div className="li">
                      ...
                      и&nbsp;Политикой конфиденциальности. Субъект персональных
                    ...
                    <div className="li">
                      ...
                      а&nbsp;также на&nbsp;обработку или условия обработки
                      (кроме получения доступа) персональных данных, разрешенных
                ...
                <div className="col">
                  ...
                  <div className="ol">
                    <div className="li">
                      ...
                      уведомить уполномоченный орган по&nbsp;защите прав
                      субъектов персональных данных о&nbsp;своем намерении
                      осуществлять трансграничную передачу персональных данных
                      (такое уведомление направляется отдельно
                      от&nbsp;уведомления о&nbsp;намерении осуществлять
              ...
              <div className="row mb-4">
                <div className="col">
                  ...
                  <div className="descr">
                    ...
                    к&nbsp;персональным данным, обязаны не&nbsp;раскрывать
                ...
                <div className="col">
                  ...
                  <div className="ol">
                    ...
                    <div className="li">
                      ...
                      >
                        https://sladko-eshka-kanash.ru/privacy
                      </span>
                      .
                    </div>
                  </div>
